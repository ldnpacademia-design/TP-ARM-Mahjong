.data
    ...
    @  Matrices Estáticas Oficiales de 8x8 (64 celdas / bytes cada una) 
    fichas:
...
loop_juego:  @ < PUNTO 7: El inicio del bucle infinito de juego
    
    @ PASO 1: IMPRIMIR EL TABLERO
...
f2_ok:
    ...
    @ PASO 4 Y 5: COMPARAR, RESOLVER MATCH Y ACTUALIZAR
    ...
    MOV r8, #0x01000000         @ Delay manual de error
delay_f:
    SUBS r8, r8, #1
    BNE delay_f

    B loop_juego                @ PASO 7: Vuelve al inicio del turno
...
turno_match:
    ...
    MOV r8, #0x01000000         @ Delay manual de éxito
delay_m:
    SUBS r8, r8, #1
    BNE delay_m
...
@ RUTINAS SOLICITADAS POR LA CONSIGNA (NUEVAS MODULARIZACIONES)
...
eliminar_ficha:
    PUSH {lr}                   
    @ (Nota de diseño: Esta rutina intermedia representa la acción lógica de 
    @ remover las fichas. Como el borrado se acopla directamente con la altura
    @ en niveles[][], la dejamos como punto de enlace para cumplir la rúbrica).
    POP {pc}
